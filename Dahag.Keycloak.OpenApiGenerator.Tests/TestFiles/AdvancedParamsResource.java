...
public class ClientResource {
    ...
    public Response getInstallationProvider(@PathParam("providerId") @DefaultValue("foo") String providerId, @DefaultValue("bar") Foo complex, @Context @DefaultValue("jank") final HttpResponse ignored) {
