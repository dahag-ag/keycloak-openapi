...
public class ClientResource {
    ...
    @GET
    @NoCache
    @Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN, MediaType.MULTIPART_FORM_DATA })
    public CredentialRepresentation getClientSecretB() {
        return ModelToRepresentation.toRepresentation(model);
    }
}
